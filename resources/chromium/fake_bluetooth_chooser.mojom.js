...
(function() {
  ...
  FakeBluetoothChooserProxy.prototype.waitForEvents = function(numOfEvents) {
    var params_ = new FakeBluetoothChooser_WaitForEvents_Params();
    params_.numOfEvents = numOfEvents;
    return new Promise(function(resolve, reject) {
      ...
      builder.encodeStruct(FakeBluetoothChooser_WaitForEvents_Params, params_);
